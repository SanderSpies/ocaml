...
asmcomp/exception_handling.ml: asmcomp/wasm32/exception_handling.ml
	cd asmcomp; $(LN) wasm32/exception_handling.ml .
...
partialclean::
	...
	rm -f asmcomp/exception_handling.ml
...
wasm32: 
	...
	rm -f asmcomp/exception_handling.cmo
